      ...
      <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-1">
        ...
        <ul class="dropdown-menu dropdown-menu-end py-0">
          <li class="dropdown-menu-header border-bottom">
            <div class="dropdown-header d-flex align-items-center py-3">
              <h5 class="text-body mb-0 me-auto">Pemberitahuan</h5>
              ...
              <li class="list-group-item list-group-item-action dropdown-notifications-item">
                <div class="d-flex">
                  <div class="flex-shrink-0 me-3">
                    <div class="avatar">
                      <img src="{{ asset('uploads/img/prof_pic.png') }}" alt class="h-auto rounded-circle" />
                    </div>
                  </div>
                  <div class="flex-grow-1">
                    <h6 class="mb-1">Welcome 🎉</h6>
                    <p class="mb-0">Selamat! Pendaftaran akun kamu berhasil.</p>
            ...
            <li>
              <a class="dropdown-item" href="pages-account-settings-billing.html">
                <span class="d-flex align-items-center align-middle">
                  ...
                  <span class="flex-grow-1 align-middle">Schedule</span>
                  <span
                    class="flex-shrink-0 badge badge-center rounded-pill bg-label-danger w-px-20 h-px-20">{{ $schedules->count() }}</span>
                </span>
              </a>
            </li>
          @endif
